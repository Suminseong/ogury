...
`,sO=R.div`
  ...
  cursor: pointer;
`;function sd(){const t=wn(),{pathname:e}=ei(),n=[{label:"홈",to:"/",iconActiveSrc:"/gongu/btmNav/home-active.svg",iconInactiveSrc:"/gongu/btmNav/home-inactive.svg"},{label:"공구",to:"/gongu",iconActiveSrc:"/gongu/btmNav/gongu-active.svg",iconInactiveSrc:"/gongu/btmNav/gongu-inactive.svg"},{label:"공구 현황",to:"/status",iconActiveSrc:"/gongu/btmNav/status-active.svg",iconInactiveSrc:"/gongu/btmNav/status-inactive.svg"},{label:"커뮤니티",to:"/community",iconActiveSrc:"/gongu/btmNav/community-active.svg",iconInactiveSrc:"/gongu/btmNav/community-inactive.svg"}];return v.jsx(aO,{children:n.map(({label:a,to:s,iconActiveSrc:l,iconInactiveSrc:h})=>{const d=e===s;return v.jsxs(sO,{$active:d,onClick:()=>t(s),children:[v.jsx("img",{src:d?l:h,alt:a}),a]},a)})})}const oO=R.div`
  width: 402px;
  height: 50px;
  background: #fff;
...
`;function g7(t){const e=wn(),[n,a]=F.useState(0),[s,l]=F.useState(""),[h,d]=F.useState([]),g=F.useRef(null),_=ei().state,E=_.title,b=async()=>{const V=new Date().getTime().toString(),B=rl(ti(Cn,"review"),V);try{await QT(B,{id:_.date,images:h,rating:n,title:E,date:V,bodys:s,comment:[]});const K=rl(Cn,"gongu",_.id);await Hy(K,{isReviewed:!0}),alert("리뷰가 작성되었습니다."),e("/community")}catch(K){console.error("리뷰 작성 실패 또는 gongu 업데이트 실패:",K)}},C=s.trim(),O=5,z=V=>{const B=O-h.length,J=Array.from(V.target.files).slice(0,B).map(re=>new Promise(ce=>{const D=new FileReader;D.onload=A=>ce({name:re.name,src:A.target.result}),D.readAsDataURL(re)}));Promise.all(J).then(re=>d(ce=>[...ce,...re]))},k=V=>d(h.filter((B,K)=>K!==V));return v.jsxs(a7,{children:[v.jsx(s7,{children:v.jsx("img",{src:"/StatusBar.png",alt:"StatusBar"})}),v.jsx(Va,{state:"TextActionBar",text:"후기 작성",disabled:!C,onClick:b}),v.jsxs(o7,{children:[v.jsxs(l7,{children:[v.jsx("p",{children:E}),v.jsx("span",{children:v.jsx("img",{src:"/gongu/arrow-right.svg",alt:""})})]}),v.jsxs(u7,{children:[v.jsxs(c7,{children:[v.jsx("label",{children:"평점"}),v.jsx(i7,{rating:n,onChange:a})]}),v.jsx(Mo,{label:"내용",placeholder:"공동구매한 상품에 대한 리뷰를 남겨주세요.",textarea:!0,value:s,onChange:V=>l(V.target.value)}),v.jsxs(h7,{children:[v.jsx("label",{children:"사진"}),v.jsxs(f7,{children:[v.jsxs(d7,{onClick:()=>g.current.click(),children:[v.jsx("span",{className:"img-icon",children:v.jsx("img",{src:"/gongu/image.svg",alt:""})}),v.jsxs("span",{className:"img-length",children:[h.length,"/",O]})]}),v.jsx("input",{ref:g,type:"file",accept:"image/*",multiple:!0,style:{display:"none"},onChange:z}),h.map((V,B)=>v.jsxs(p7,{children:[v.jsx("img",{src:V.src,alt:V.name}),v.jsx("button",{onClick:()=>k(B),children:v.jsx("img",{src:"/gongu/delete.svg",alt:"삭제"})})]},B))]})]})]})]})]})}const m7=R.div`
  display: flex;
  justify-content: center;
