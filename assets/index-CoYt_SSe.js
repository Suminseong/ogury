...
`,"리뷰를 남겨볼까요?"]}),v.jsx(vP,{children:l.map(g=>v.jsx(_P,{onClick:()=>a(g.id),style:{border:n===g.id?"1px solid #4F8FFF":"1px solid #fff",background:n===g.id?"#eaf2ff":"#fff"},children:v.jsxs(xP,{children:[v.jsx(wP,{image:g.images[0]}),v.jsxs(bP,{children:[v.jsx(EP,{children:g.title}),v.jsxs(TP,{children:["참여일: ",d(g.date)]})]})]})},g.id))})]}),v.jsxs(SP,{children:[v.jsx(AP,{onClick:s,disabled:n===null,style:{background:n===null?"#f7f7f7":"#4F8FFF",color:n===null?"#aeafb6":"#fff",cursor:n===null?"not-allowed":"pointer"},children:"다음"})," "]})]})},RP=cA.createRoot(document.getElementById("root"));RP.render(v.jsx(S4,{basename:"/ogury",children:v.jsxs(t4,{children:[v.jsx(zr,{path:"/",element:v.jsx(fO,{})}),v.jsx(zr,{path:"/gongu",element:v.jsx(zO,{})}),v.jsx(zr,{path:"/gongu/new",element:v.jsx(t7,{})}),v.jsx(zr,{path:"/status",element:v.jsx(P7,{})}),v.jsx(zr,{path:"/gongu/:id",element:v.jsx(PM,{})}),v.jsx(zr,{path:"/community",element:v.jsx(F7,{})}),v.jsx(zr,{path:"/selectGongu",element:v.jsx(CP,{})}),v.jsx(zr,{path:"/community/new",element:v.jsx(g7,{})}),v.jsx(zr,{path:"/community/:id",element:v.jsx(dP,{})})]})}));
